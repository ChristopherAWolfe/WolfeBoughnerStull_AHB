...
# The following script performs 5-fold cross validation assuming an ordinal
# predictor variable. This script outputs a csv to the project directory with 
# log likelihood values for a ordinal age model. 

set.seed(855)

## Import Models
full_mod <- cmdstan_model("stan_models/mvp_ordinal.stan")
test_mod <- cmdstan_model("stan_models/mvp_ordinal_log_lik.stan")
